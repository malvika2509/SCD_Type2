...
def create_target_table_if_not_exists(target_table_name: str, target_columns: list, db: Session):
    ...
    print('Ressssssssssssssssss',result)
    ...
    # Make the surrogate key (e.g., CustomerKey) the primary key and ensure it's an IDENTITY column
    ...
    print('//////',primary_key_column,surrogate_key_column)
